...
class Display:
    ...
    def display(self, data):
        ...
        calIcon = self.offscreen_canvas.SetImage(image1.convert('RGB'), 4, 4)
        ...
        Dtxt = graphics.DrawText(self.offscreen_canvas, self.font2,  18, 13, graphics.Color(255, 255, 255), str("June 10"))
